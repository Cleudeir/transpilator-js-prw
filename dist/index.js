...
function transpile(jsCode, fileName) {
    try {
...
function generateSimpleJsSpecial() {
    return `#INCLUDE "Protheus.ch"
...
function generateImportJsSpecial() {
    return `#INCLUDE "Protheus.ch"
#INCLUDE "utils\\tax.ch"
...
function transpileFile(filePath, outputDir) {
    try {
